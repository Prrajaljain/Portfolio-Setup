    ...
    <section className="border-t border-[#e6e5e0] bg-[#f7f7f4] py-16">
      <div className="mx-auto max-w-5xl px-6">
        <div className="mb-10 text-left">
          <span className="mb-3 inline-flex items-center gap-2 rounded-sm border border-[#e6e5e0] bg-[#ffffff] px-3 py-1 font-mono text-[11px] font-semibold uppercase tracking-wider text-[#4A4744]">
          ...
          {principles.map((p) => (
            ...
            >
              ...
              <div>
                ...
                <p className="mt-3 text-sm leading-relaxed text-[#2D2B28]">
                  {p.description}
                </p>
              </div>
            </div>
