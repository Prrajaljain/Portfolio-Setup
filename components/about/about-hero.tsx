    ...
    <SectionWrapper id="about" className="relative overflow-hidden border-b border-[#E8E4DE] bg-[#F5F4F0] text-[#1A1A1A] py-16">
      <div className="mx-auto grid max-w-6xl gap-12 px-6 lg:grid-cols-[1fr_340px] lg:items-center lg:gap-14">
        <div className="flex flex-col gap-5 text-left">
          <span className="inline-flex w-fit items-center gap-2 rounded-sm border border-[#E8E4DE] bg-[#FFFFFF] px-3 py-1 font-mono text-xs font-semibold uppercase tracking-wider text-[#4A4744] shadow-rest">
          ...
          <h1 className="text-balance text-3xl font-bold leading-tight tracking-tight sm:text-5xl text-[#1A1A1A]">
            Most models never leave the laptop.{' '}
            <span className="font-bold text-[#F25C1F]">
              Mine do.
            </span>
          </h1>

          <div className="space-y-4 text-base leading-relaxed text-[#2D2B28]">
            <p>
          ...
          <div className="flex flex-wrap gap-3 font-mono text-xs text-[#2D2B28] pt-2">
