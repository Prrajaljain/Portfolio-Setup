...
export function SiteFooter() {
  ...
  return (
    <footer className="relative z-20 border-t border-[#e6e5e0] bg-[#f7f7f4] py-8 text-xs text-[#807d72]">
      <div className="mx-auto flex max-w-5xl flex-col items-center justify-between gap-4 px-6 sm:flex-row">
        {/* Copyright Text */}
        <p className="text-center sm:text-left font-mono">
          Copyright 2025 &ndash; {currentYear} {profile.name} &ndash; All Rights Reserved
        </p>
        ...
        <div className="flex items-center gap-2.5 font-mono">
          ...
          <a
            href="https://linkedin.com/in/prajaljain23"
            target="_blank"
            rel="noreferrer"
            aria-label="LinkedIn"
            className="flex size-8 items-center justify-center rounded-sm border border-[#e6e5e0] bg-[#ffffff] text-[#26251e] transition-colors hover:border-[#cfcdc4] hover:text-[#f54e00]"
