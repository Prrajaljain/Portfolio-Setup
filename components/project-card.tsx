  ...
  return (
    <div className="group relative flex h-full flex-col overflow-hidden rounded-md border border-[#e6e5e0] bg-[#ffffff] p-5 text-left transition-all duration-200 hover:border-[#cfcdc4] hover:-translate-y-0.5">
      ...
      <div className="flex flex-1 flex-col">
        <h3 className="mb-2 text-lg font-semibold leading-tight text-[#26251e] transition-colors group-hover:text-[#f54e00]">
          {project.title}
        </h3>

        <p className="mb-4 text-xs sm:text-sm leading-relaxed text-[#5a5852]">
          {project.description}
        </p>
